...
class Angle(Arc):
    '''
    用法：Angle(dot_1, dot_2, dot_3)
    dot_1, dot_2, dot_3按顺时针顺序, dot_2是角的顶点
    '''
    CONFIG = {
        "radius": 0.5,
        "color": WHITE,
    ...
    def add_label(self, label,buff=MED_LARGE_BUFF):
        '''
        不能在申明时使用
        '''
        label.add_updater(lambda m: m.move_to(self.get_label_loc(buff)))
